        ...
        <div className="h-12 bg-primary flex justify-between items-center px-6 topheader_text">
            ...
            <div className='flex'>
                <ul className='flex justify-between items-center space-x-4 topheader_social_link'>
                    <li data-aos="fade-down" data-aos-delay="800"><a href='https://www.facebook.com/profile.php?id=61567603241017' target='_blank' rel='noreferrer' className='flex relative group' data-tooltip-target="bottom-tooltip"><span className="raphael--facebook"></span>
...
<p className="text-xs text-[var(--primarycolor)] font-light">Follow us on facebook.</p></div>
                    ...
                    <li data-aos="fade-down" data-aos-delay="900"><a href='https://www.instagram.com/lacuisine.cafe?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==' target='_blank' rel='noreferrer' className='flex relative group' data-tooltip-target="bottom-tooltip"><span className="simple-line-icons--social-instagram"></span>
...
<p className="text-xs text-[var(--primarycolor)] font-light">Follow us on instagram.</p></div></a></li>
                    <li data-aos="fade-down" data-aos-delay="1000"><a href='https://www.tiktok.com/@lacuisinecafe' target='_blank' rel='noreferrer' className='flex relative group' data-tooltip-target="bottom-tooltip"><span className="hugeicons--tiktok"></span>
